        ...
        <main class="row d-flex">
            ...
            <?PHP
                ...
                if (isset($_REQUEST["cambiarDatos"])) {
                    modificarDatosUsuario($_SESSION["usuarioActual"][0], $_REQUEST["nuevoNombre"], $_REQUEST["nuevoApellido"], $_REQUEST["nuevoDNI"], $_REQUEST["nuevoCorreo"], $_REQUEST["nuevoconfContraseña"]);
                }
            ?>
                <section class="col-12 col-xl-6 bg-light d-flex p-2 flex-column justify-content-center align-items-center rounded" style="margin-right: 7%;">
                    <h1 style="color: black;">Bienvenido <?= $_SESSION["usuarioActual"][1] ?> <?= $_SESSION["usuarioActual"][2] ?></h1>
                    <hr style="width: 100%;">
                    ...
                    <form action="menuPrincipal.php" style="width: 100%;" class="d-flex p-4 flex-column justify-content-center align-items-center" method="post">
                        <section class="d-flex justify-content-between align-items-center" style="width: 100%;">
                            ...
                            <input type="text" value="<?= $_SESSION["usuarioActual"][0] ?>" disabled style="width: 50%;">
                        </section>
                        <section class="d-flex justify-content-between align-items-center" style="width: 100%;">
                            <label for="nombre">Nombre: </label>
                            <input type="text" placeholder="<?= $_SESSION["usuarioActual"][1] ?>" style="width: 50%;" name="nuevoNombre" id="nombre">
                        </section>
                        <section class="d-flex justify-content-between align-items-center" style="width: 100%;">
                            <label for="apellidos">Apellidos: </label>
                            <input type="text" placeholder="<?= $_SESSION["usuarioActual"][2] ?>" style="width: 50%;" name="nuevoApellido" id="apellidos">
                        </section>
                        <section class="d-flex justify-content-between align-items-center" style="width: 100%;">
                            <label for="dni">DNI: </label>
                            <input type="text" placeholder="<?= $_SESSION["usuarioActual"][3] ?>" style="width: 50%;" name="nuevoDNI" id="dni">
                        </section>
                        <section class="d-flex justify-content-between align-items-center" style="width: 100%;">
                            <label for="correo">Correo: </label>
                            <input type="email" placeholder="<?= $_SESSION["usuarioActual"][4] ?>" style="width: 50%;" name="nuevoCorreo" id="correo">
                        </section>
                        <section class="d-flex justify-content-between align-items-center" style="width: 100%;">
                ...
                <section class="col-12 col-xl-5 bg-light d-flex p-1 flex-column justify-content-center rounded">
                    ...
                    if (in_array("Agricultor", $_SESSION["listaRoles[]"])) {
                        $parcelasActuales = obtenerParcelas($_SESSION["usuarioActual"][0]);
                        if (@count($parcelasActuales) > 0) {
                    ?>
                        <article class="col-12 col-xl-5 bg-light mt-2" style="width: 100%;">
                            <div id="carouselParcelas" class="carousel slide" data-bs-ride="carousel" style="width: 100%;">
                                <div class="carousel-inner">
                                   <?PHP
                                        for ($i = 0; $i < @count($parcelasActuales); $i++) {
                                            if ($i == 0) {
                                    ?>
                                                <div class="carousel-item active">
                                                    <div class="card" style="width: 80%; margin: auto auto; text-align: center; border: 1px solid black;">
                                                        <div class="card-body">
                                                            <h5 class="card-title">Parcela con ID <?= $parcelasActuales[$i][0] ?></h5>
                                                            <p class="card-text">Nombre parcela: <?= $parcelasActuales[$i][1] ?></p>
                                                            <p class="card-text">Area: <?= $parcelasActuales[$i][2] ?></p>
                                                            <p class="card-text">Ubicado en: <?= devolverProvincia($parcelasActuales[$i][5]) ?></p>

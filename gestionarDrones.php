    ...
    ?>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex">
                            ...
                            if (isset($_SESSION["listaRoles[]"])) {
                                ...
                                ?>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="gestionarDrones.php">Gestionar drones <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-command">
        ...
        <main class="row d-flex">
            ...
            ?>
                ...
                if (isset($_REQUEST["habilitarDron"])) {
                    añadirDron($_SESSION["usuarioActual"][0], $_REQUEST["modeloDron"], $_REQUEST["marcaDron"]);
                }

                if (isset($_REQUEST["registrarDron"])) {
                ?>
                    <section class="container col-12 col-xl-6 d-flex flex-column p-2" style="background-color: white; margin-top: 5vh">
                        <h3 style="text-align: center">Registrar dron</h3>
                        <form action="gestionarDrones.php" method="post" class="d-flex flex-column justify-content-center align-items-center rounded">
                ...
                if (isset($_REQUEST["idDr"])) {
                    borrarDron($_SESSION["usuarioActual"][0], $_REQUEST["idDr"]);
                }
                ?>
                <section class="container col-12 col-xl-8 d-flex flex-column p-2" style="background-color: white; margin-top: 10vh;">
                    <h3 style="text-align: center">Mis drones</h3>
                    <?PHP
                    $drones = verDrones($_SESSION["usuarioActual"][0]);
                    if (@count($drones) > 0) {
                    ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $drones[$i][2] ?></td>
                                        <td><?= $drones[$i][3] ?></td>
                                        <td><a href="gestionarDrones.php?idDr=<?= $drones[$i][0] ?>" class="btn btn-danger">Borrar dron</a></td>
                                    <tr>
                                    <?PHP
                                }
                                    ?>
                                    <tr>
                                        <td colspan="4"><a href="gestionarDrones.php?registrarDron" class="btn btn-primary">Registrar dron</a></td>
                                    </tr>
                            </tbody>
                        </table>
                    <?PHP
                    ...
                    ?>
                        <a href="gestionarDrones.php?registrarDron=true" class="btn btn-primary">Registrar dron</a>
                    <?PHP
                    }
                    ?>
                </section>
